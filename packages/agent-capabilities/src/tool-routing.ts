...
export const TOOL_ROUTING_RULES: readonly ToolRoutingRule[] = [
  ...
  },
  {
    ...
    requiresCurrentTarget: false,
    resultFrame: "set",
    selectionGuidance: "For an overview, ‘what's wrong with my design’, current UI focus, retained-revision delta, or genuine ambiguity, call review_current_design. Lead with one finding from present evidence; you may discuss mechanism categories that might help, but do not recommend specific catalog components or a required topology.",
    positiveExamples: ["what's wrong with my design", "review my design", "how is my architecture looking?"],
