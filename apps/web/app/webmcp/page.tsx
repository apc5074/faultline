...
const PROMPT_GROUPS = [
  {
    ...
    prompt: "Walk me through the current configured request path like a systems teacher. Cover at most three important connected components, explain their roles, and identify one simulator-backed constraint. Treat any absent infrastructure as hypothetical and use persistent visual marks only when useful.",
  ...
  },
  {
    ...
    prompt: "What is the single biggest simulator-backed problem in my current design, if one exists? Explain the numbers in plain language, mark the responsible component only if useful, and ask me one question about how I want to improve it.",
  ...
  },
  {
    ...
    prompt: "I selected a component. Use current evidence to explain what it is doing, what is saturating or under pressure, and why that affects the user-facing requirement. Include its verified neighbors and relevant path; do not assume absent components or prescribe a topology.",
  ...
  },
  {
    ...
    prompt: "I just changed the design without pressing Run. Compare the current live draft with the previous evidence revision if a valid baseline exists; otherwise say comparison is unavailable. Explain any changed outcome or tradeoff without claiming official verification.",
  ...
  },
  {
    ...
    prompt: "Find the most credible simulator-supported way this current design could fail under the active workload. Explain the hypothesis and evidence first, then propose one bounded simulated test. Wait for my explicit approval before running anything.",
