  ...
  return (
    <main className="home-page">
      <section className="home-page__landing" aria-labelledby="home-page-title">
        ...
        <section className="home-page__hero">
          <p className="home-page__eyebrow">
            Daily distributed-systems design game
          </p>
        ...
        <footer className="home-page__footer">
          ...
          >
            <svg viewBox="0 0 24 24" aria-hidden="true">
              <path
                d="M18.9 2h3.68l-8.04 9.19L24 22h-7.41l-5.8-7.59L4.15 22H.47l8.6-9.83L0 2h7.6l5.24 6.93L18.9 2Zm-1.29 18h2.04L6.49 3.9H4.3L17.61 20Z"
                fill="currentColor"
              />
            </svg>
          </a>
      ...
      <section
        ...
        className="home-page__leaderboard"
        aria-labelledby="today-leaderboard-title"
      >
